...
//			con.close();
    ...
    public Customer getCustomer(String username) {
                Connection con = DBConnect.getConnecttion();
		String sql = "select customer.ID, tel, userName, password, noHome, street, district, city, firstName, lastName, midName  from account, customer, fullname, address where account.CustomerID = customer.ID and fullname.CustomerID = customer.ID and address.CustomerID = customer.ID and account.UserName = 'Cuong'";
		User u = new User();
		try {
			...
			while (rs.next()) {
				...
				String userName = rs.getString("userName");
				String password = rs.getString("password");
				String noHome = rs.getString("noHome");
				...
				String firstName = rs.getString("firstName");
                                ...
                                cus.setAddress(new Address(noHome, street, district, city));
                                cus.setFullname(new FullName(firstName, lastName, midName));
                                return cus;
			}
			con.close();
		} catch (SQLException e) {
